        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Interns Assesment</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                              ...
                              <td>{{$record->place_of_intern}}</td>
                               ...
                               <div class="btn-group">
                                  ...
                                  <div class="dropdown-menu">
                                      <a class="dropdown-item" href="{{URL::to('/admin/interns/generalassesment/'.$record->id)}}"><i class="fa fa-eye"></i>General Assesment </a>
                                      <a class="dropdown-item" href="{{URL::to('/admin/interns/projectassesment/'.$record->id)}}"><i class="fa fa-eye"></i>Technical Skills Evaluation</a>
                                      <a class="dropdown-item" href="{{URL::to('/admin/interns/score/'.$record->id)}}"><i class="fa fa-eye"></i>View Scores</a>
                                  </div>
                               </div>
                            </td>
                              ...
                              {{csrf_field()}}
                                <div class="card-body">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="text" name="phonenumber" class="form-control" id="exampleInputEmail1" placeholder="Enter Full Name">
                                  </div>
                                  
                                   <div class="form-group">
                                    <label for="exampleInputEmail1">Area Of Study</label>
                                    <input type="text" name="area_of_study" class="form-control" id="exampleInputEmail1" placeholder="Enter Full Name">
                                  </div>
