        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#" class="btn btn-success" onclick="window.print()"><i class="fa fa-print">Print receipt</i></a></li>
        ...
        <div class="row">
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row">
                  <div class="col-sm-4">
                      <p style="color:blue;font-size:50px"><strong>RECEIPT</strong></p>
                  </div>
                  <div class="col-sm-3"></div>
                  <div class="col-sm-5">
                      <P style="color:blue;font-size:50px">NO. &nbsp; <b style="color:red">{{$std->receipt_no}}</b></P>
                  </div>
              </div>
              <div class="row">
                  <div class="col-sm-12">
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                  <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                <td>{{$std->amount_paid}}</td>
                                <td>School Fees</td>
                                <td>{{$std->payment_mode}}</td>
                                <td>{{$std->reference_no}}</td>
