	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form"  action="{{route('resetpasswords.insertpasswordupdate)}}" method="GET">
				    @if ($errors->any())
				   ...
				   @csrf
					...
					<div class="wrap-input100 validate-input m-b-26" style="display:none">
						...
						<input id="id" type="text" class="input100" name="id" value="{{$user->id}}">
						<span class="focus-input100"></span>
					</div>

                   <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">New Password</span>
						<input id="email" type="password" class="input100 " name="password"  required  placeholder="Enter New password">
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						<span class="label-input100">Confirm Password</span>
						<input id="email" type="password" class="input100" name="password_confirmation"  required  placeholder="confirm password">
						<span class="focus-input100"></span>
					</div>
