            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row invoice-info">
                   <center>
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       ASSETS REGISTRATION AND MANAGEMENT</p>
                   </center>
              </div>
              <!-- /.row -->
              <div class="row">
                  <div class="col-sm-4">
                      <form action="{{route('assets.create')}}" method="POST">
                         ...
                         <table class="table table-bordered">
                             <tr>
                                 <td>Asset Name</td>
                                 <td><input type="text" name="assetName" class="form-control"></td>
                             </tr>
                             <tr>
                                 <td>Serial Number</td>
                                 <td><input type="text" name="serialNumber" class="form-control"></td>
                             </tr>
                             
                             <tr>
                                 <td>Asset Model</td>
                                 <td><input type="text" name="assetModel" class="form-control"></td>
                             </tr>
                                 ...
                                 <td>Asset Type/Category</td>
                                  <td>
                                      <select name="assetType" class="form-control" required >
                                          ...
                                          <option value="Ict Hardware">Ict Hardware</option>
                             ...
                             <tr>
                              ...
                              <tr>
                                 <td>Order Number</td>
                                 <td><input type="text" name="orderNumber" class="form-control"></td>
                             </tr>
                             
                              <tr>
                                 <td>Purchase Cost</td>
                                 <td><input type="text" name="purchaseCost" class="form-control"></td>
                             </tr>
                              ...
                              <tr>
                                 <td>Warranty</td>
                                 <td><input type="text" name="waranty" class="form-control"></td>
                             </tr>
                             <tr>
                                
                                 <td colspan="2"><input type="submit" name="submit" value="Add" class="btn btn-primary" style="float:right;"></td>
                             </tr>
