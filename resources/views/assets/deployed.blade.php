                         ...
                         @if(!empty($data))
                             @foreach($data as $key=>$record)
                                  <tr>
                                      ...
                                      <td>
                                          ...
                                          <div class="dropdown">
                                              ...
                                              <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#undeploy{{$record->id}}"><i class="fa fa-trash">Un Deploy</i></a>
                                     ...
                                     <div class="modal fade" id="undeploy{{$record->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Do you want to change the status of this item to "Not Deployed"? </h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                              <span aria-hidden="true">&times;</span>
                                            </button>
                                          </div>
                                           <form action="{{route('assets.undeploy')}}" method="POST">
                                             @csrf
                                              <div class="modal-body">
