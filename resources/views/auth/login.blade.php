				...
				<form class="login100-form validate-form"  method="POST"  action="{{ route('login') }}">
				   ...
				   @csrf
					<div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
						...
						<input id="email" type="text" class="input100 @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" placeholder="Enter username" autofocus>
					...
					<div class="flex-sb-m w-full p-b-30">
						<div class="contact100-form-checkbox">
							...
							<div>
							<a href="{{route('resetpasswords.index')}}" class="txt1">
							 Forgot Password
							</a>
						</div>
					</div>
