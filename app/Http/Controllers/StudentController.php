...
class StudentController extends Controller
{
    ...
    public function insert(Request $request)
    {
        ...
        'phonenumber' => ['regex:/(2547)[0-9]{8}/', 'string','numeric','digits:12','unique:students'],
        'alternate_phonenumber' => ['regex:/(2547)[0-9]{8}/', 'string','numeric','digits:12','unique:students'],
       ...
       if($student->save()){
         ...
         if($courseapp->save()){
             ...
             $insertUser=DB::table('users')->insert([
                 ...
                 'lastname'=>ucwords($request->full_name),
